...
function unite_woocommerce_menucart($menu, $args) {
  ...
  ob_start();
    ...
    // if ( $cart_contents_count > 0 ) {
      if ($cart_contents_count == 0) {
        $menu_item = '</ul><ul class="nav navbar-nav navbar-right"><li class="dropdown"><a class="woomenucart-menu-item dropdown-toggle"  data-toggle="dropdown" href="'. $shop_page_url .'" title="'. $start_shopping .'">';
      } else {
